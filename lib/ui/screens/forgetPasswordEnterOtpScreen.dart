...
class ForgetPasswordEnterOtpScreen extends StatefulWidget {
  ...
  ForgetPasswordEnterOtpScreen(this.args);

  @override
  State<ForgetPasswordEnterOtpScreen> createState() => _ForgetPasswordEnterOtpScreenState();
}

class _ForgetPasswordEnterOtpScreenState extends State<ForgetPasswordEnterOtpScreen> {
  //const ForgetPasswordEnterOtpScreen({Key? key}) : super(key: key);
                              ...
                              return Padding(
                                ...
                                child: ButtonBig(
                                  onTap: (){
                                    ...
                                    if(otp.length != 5){
                                      Utils.toastMessage("Please enter the 5-digit OTP");
                                    }else{
                                      Navigator.pushReplacementNamed(context, RoutesName.forgetPasswordNewPasswordScreen,
                                          arguments: {"email" : "${widget.args!["email"]}", "otp": "${otp}" }
                                      );
